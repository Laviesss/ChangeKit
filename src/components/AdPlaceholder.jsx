export default function AdPlaceholder({ type = 'leaderboard' }) {
  ...
  return (
    <div className={`mx-auto bg-[#1a1a1a] border border-gray-800 rounded-lg flex items-center justify-center text-xs text-gray-500 font-mono ${dimensions} overflow-hidden shadow-sm hover:border-purple-accent/30 transition-colors animate-pulse`}>
